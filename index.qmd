...
1. Replace the name placeholder "Astral Projection" on `index.qmd` with your name or group name.
2. Replace the name placeholder "Astral Projection" on `_quarto.yml` with your name or group name.
3. Replace the repository link `https://github.com/pjournal/mef07g-astralprojection` with your or your group's repository link.
...
Our group project is Astral Projection.
